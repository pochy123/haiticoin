...
// trigger: synchronized checkpoint (centrally broadcasted)
...
// trigger: get last synchronized checkpoint
...
// trigger: only descendant of current sync-checkpoint is allowed
...
// trigger: reset synchronized checkpoint to last hardened checkpoint
...
// trigger: verify signature of sync-checkpoint message
...
// trigger: process synchronized checkpoint
