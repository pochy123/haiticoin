...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Trigger address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and trigger: URIs)"));
...
//    connect(multisigAction, SIGNAL(triggered()), this, SLOT(gotoMultisigPage()));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Trigger addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Trigger addresses"));
    ...
    openAction->setStatusTip(tr("Open a trigger: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Trigger command-line options").arg(tr(PACKAGE_NAME)));

    openChatroomAction = new QAction(QIcon(":/icons/trigger"), tr("&Chatroom"), this);
    openChatroomAction->setStatusTip(tr("Open the Trigger Discord in a web browser."));

    openForumAction = new QAction(QIcon(":/icons/trigger"), tr("&Forum"), this);
    openForumAction->setStatusTip(tr("Open https://talk.trigger.net in a web browser."));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Trigger network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Trigger"); // default title
