...
/** trigger: Number of consecutive PoS headers are allowed from a single peer. Used to prevent out of memory attack. */
...
public:
    ...
    uint256 hashCheckpointKnown; // trigger: known sent sync-checkpoint
    ...
    // trigger: used to detect branch switches
