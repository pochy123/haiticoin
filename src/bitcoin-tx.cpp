...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help") || gArgs.IsArgSet("-version"))
    {
        ...
        std::string strUsage = strprintf(_("%s trigger-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  trigger-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded trigger transaction") + "\n" +
              "  trigger-tx [options] -create [commands]   " + _("Create hex-encoded trigger transaction") + "\n" +
              "\n";
